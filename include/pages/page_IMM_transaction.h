...
#ifndef PAGE_IMM_TRANSACTION_H
#define PAGE_IMM_TRANSACTION_H
...
{
  class CPageIMMTransaction : public CPageTransactionView
  {
  public:
    CPageIMMTransaction(CApplication &, std::unique_ptr<parameters_t>);

    void refreshTableView();

    static std::unique_ptr<CPageIMMTransaction> createClass(CApplication &parent, std::unique_ptr<parameters_t> p)
    {
      return std::make_unique<CPageIMMTransaction>(parent, std::move(p));
    }

  protected:
    virtual void createUI() override;
    virtual constexpr objectType_t objectTypeID() const override { return OT_IMM_TRANSACTION; }
  ...
  private:
    CPageIMMTransaction() = delete;
    CPageIMMTransaction(CPageIMMTransaction const &) = delete;
    CPageTransaction &operator=(CPageIMMTransaction const &) = delete;
