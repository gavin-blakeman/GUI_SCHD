...
namespace transactionPages
{
  ...
  CPageIMMClientTransaction::CPageIMMClientTransaction(CApplication &parent, std::unique_ptr<parameters_t> p)
  ...
  void CPageIMMClientTransaction::clearFields()
  {
  ...
  void CPageIMMClientTransaction::createUI()
  {
    tableStore.clear();
    ...
    lineEditTransaction = bindWidget<Wt::WLineEdit>(result, "lineEditTransaction");
    ...
    auto btn = bindWidget<Wt::WPushButton>(result, "actionButton", "Action");
    {
    ...
    lineEditStatus = bindWidget<Wt::WLineEdit>(result, "lineEditStatus");
    ...
    comboBoxTransactionType = bindWidget<Wt::WComboBox>(result, "comboBoxTransactionType");
    ...
    comboBoxPortfolio = bindWidget<Wt::WComboBox>(result, "comboBoxPortfolio");
    ...
    comboBoxExchange = bindWidget<Wt::WComboBox>(result, "comboBoxExchange");
  ...
  void CPageIMMClientTransaction::enableEdit(bool enable)
  {
  ...
  void CPageIMMClientTransaction::populateFields()
  {
  ...
  void CPageIMMClientTransaction::saveComplete()
  {
    ...
    switch(internalMode)
    {
      ...
      default:
      {
        CPageIMMClientTransaction::saveComplete();
        break;
      }
  ...
  void CPageIMMClientTransaction::processSaveData()
  {
  ...
  void CPageIMMClientTransaction::createLine(bool dataExists)
  {
    tableRow_t tableRow;
    ...
    tableRow.pushButtonDelete->buttonClicked().connect(this, &CPageIMMClientTransaction::deleteCostLine);
    ...
    tableRow.comboBoxType->changed().connect(this, &CPageIMMClientTransaction::comboBoxTypeChanged);

    // Cost

    tableRow.spinBoxCost = tableCostLine->elementAt(row, ++column)->addNew<extendedDoubleSpinBox>(tableStore.size());
    tableRow.spinBoxCost->changed().connect(this, &CPageIMMClientTransaction::spinBoxValueChanged);
  ...
  void CPageIMMClientTransaction::deleteCostLine(std::size_t rowID)
  {

    std::cout << "Delete Cost Line0" << std::endl;
    ...
    std::cout << "Delete Cost Line2" << std::endl;

    tableCostLine->removeRow(rowID + 1);
    tableStore.erase(tableStore.begin() + rowID);

    std::cout << "Delete Cost Line3" << std::endl;
  }
  ...
  void CPageIMMClientTransaction::comboBoxTypeChanged(std::size_t row)
  {
  ...
  void CPageIMMClientTransaction::spinBoxValueChanged(std::size_t row)
  {
  ...
  void CPageIMMClientTransaction::updateCosts()
  {
    money_t total;
    money_t totalFees;
    money_t basePrice;
